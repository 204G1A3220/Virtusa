    ...
    function invokeScriptExecution() {
        ...
        for (; script_index < document.getElementsByTagName("script").length; script_index++) {
            try{
                if (-1 !== document.getElementsByTagName("script")[script_index].getAttribute("src").indexOf("4VdG6Vqg6BRx121714193455TLgKvOQI")) {
        ...
        if (shouldExecuteIntially === "true") {
            ...
            fetch("".concat("https://app.wotnot.io", "/v2/bot-preference?id=").concat(("4VdG6Vqg6BRx121714193455TLgKvOQI" || ""), "&is_source_web_preview=0&timezone=").concat(timezone, "&web_url=").concat(encodeURIComponent(embedMetaData ? window.document.referrer || window.location.href : window.location.href), "&browser_language=").concat(navigator.language || navigator.userLanguage, "&referrer_url=").concat(embedMetaData ? window.document.referrer : window.parent.document.referrer || '', "&script_source=").concat(("https://cdn.wotnot.io/modern-chat-bubble/51dd280" || "").split('/').slice(-1)[0] || null).concat((embedMetaData && embedMetaData.bot_publish_key) ? "&bot_publish_key=" + embedMetaData.bot_publish_key : ""), {
                credentials: 'include'
            }).then(function(res) {
                return res.json().then(function(data) {
                    if (data.is_active) {
                        var main_div = document.createElement("div");
                        main_div.innerHTML = ' <input type="hidden" value="4VdG6Vqg6BRx121714193455TLgKvOQI" class="secret-key" /> <input type="hidden" id="bucket-conversation-attachment" value="wotnot-conversation-attachment"/> <input type="hidden" value="" id="preference-response" /> <input type="hidden" id="wt-referral-url" value=""/>  <div id="chat-bot"></div>  <div id="modal-root" style="height: 100%;width: 100%;border: none;background-color: #000; display: none;position: fixed;top: 0px;z-index: 2147483647;"> </div><iframe id="overlay-iframe" style="height: 100%; width: 100%; border: none; background-color: rgba(0, 0, 0, 0.8); display: none; visibility: hidden; position: fixed; top: 0px; z-index: 2147483647;"> </iframe>';
                        var vendors_main = document.createElement("script");
                        var main = document.createElement("script");
                        vendors_main.src = "https://cdn.wotnot.io/modern-chat-bubble/51dd280/vendors~main.js";
                        main.src = "https://cdn.wotnot.io/modern-chat-bubble/51dd280/main.js";
